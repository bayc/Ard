...
case_dir = "optimization_demo_out/gridfarm_9turbs_7500maxcablelength_200iters_COBYLA"
...
for i in range(n_iters):
    ...
    axes[0,0].set(xlabel='Iterations', ylabel='Max Tower Base Load [kN*m]', title='Optimization History')
    axes[0,0].grid()
