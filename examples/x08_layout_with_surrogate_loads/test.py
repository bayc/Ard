...
layout_x1 = np.array([-0.20271659377132434, 1.0330191441290306, 1.5000000000000002, -0.5936496738788161, 0.05660959256604075, -0.989616222253975, 0.5871664726789299, 1.3169935605378682, -1.4062500000000002]
) * 1000
layout_y1 = np.array([0.3965146506696279, -0.11136908825048254, -0.506890821167131, -1.1090748511081363, -0.4378589005133406, 1.0423691396057668, -0.6088821660380159, -1.3928693595157504, -0.8320874661083904]
) * 1000

layout_x2 = np.array([-0.31400864565010017, 1.0047344940756333, 1.4525852029799766, -0.7846008716636612, 0.08740062662358594, -0.9200601773137437, 0.6082269719805001, -0.4873291971714492, 0.3937103246115571]
) * 1000
layout_y2 = np.array([0.12724170819207956, -0.9347961282087262, -0.4696786570011106, -1.1371800443250417, -0.97453501660436, 0.27704924211315696, -0.8167030240800927, -0.7972954122816748, -0.1577146369397396]
) * 1000

layout_x3 = np.array([-0.036383966650212186, 1.1880246089218498, 0.7971048984844102, 0.47869435351038575, 0.18429127631926465, 0.2629841424804841, 0.9213222498950818, 0.6123212219961761, 1.4064493845550643]
) * 1000
layout_y3 = np.array([0.1643780842499823, -0.9729119102405519, -0.373419310907611, -0.47437663425022725, -0.052887826833609076, 0.36946003438711345, -0.8651946035437885, -0.1658524651604678, -1.2611187111692026]
) * 1000
...
plt.savefig("turbine_layouts.png")
plt.savefig("turbine_layouts.pdf", format='pdf')
plt.close()
...
plt.savefig('dels_dist.pdf', format='pdf')
plt.close()
